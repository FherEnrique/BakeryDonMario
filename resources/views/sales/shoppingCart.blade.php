                                    ...
                                    <div class="p-2 flex bg-white hover:bg-gray-100 cursor-pointer border-b border-gray-100">
                                        <div class="flex-auto text-sm w-32">
                                            <div class="font-bold">Producto: {{ $detailsShoopingCart->name }}</div><div>
                                                Cantidad:
                                                <input type="number" min="1" max="1000" value="{{ $detailsShoopingCart->stock }}" id="textSearch" name="textSearch" class="w-20 pl-3 py-2 border-2 border-gray-200 rounded-xl hover:border-gray-300 focus:outline-none focus:border-blue-300 transition-colors">
                                            </div>
